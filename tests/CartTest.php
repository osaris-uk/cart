...
use OsarisUk\Cart\Models\CartLine;
...
class CartTest extends Orchestra\Testbench\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->loadMigrationsFrom([
            '--database' => 'testbench',
            '--path' => realpath(__DIR__.'/../src/OsarisUk/Cart/database/migrations'),
        ]);
    }

    protected function getPackageProviders($app)
    {
        return [OsarisUk\Cart\CartServiceProvider::class];
    }

    protected function getPackageAliases($app)
    {
        return [
            'Cart' => OsarisUk\Cart\Facades\Cart::class
        ];
    }
    ...
    public function testCleanup(){
        ...
        $cmd = new OsarisUk\Cart\Console\Commands\CartCleanup();
        DB::enableQueryLog();
        $cmd->handle();

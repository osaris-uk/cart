...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | If you extend the  OsarisUk\Cart\Models\Cart class then specify child
    | class namespace here
    |
    */

    'cart_model' => OsarisUk\Cart\Models\Cart::class,
    ...
    */
    ...
    'cart_line_model' => OsarisUk\Cart\Models\CartLine::class,
